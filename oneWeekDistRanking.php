...
$sql = "SELECT member.userName, kmRecord.userID, $keys[0] + $keys[1] + $keys[2] + $keys[3] + $keys[4] + $keys[5] + $keys[6] as \"week_sum\", member.userProfileNum FROM kmRecord JOIN member ON kmRecord.userID = member.userID ORDER BY week_sum DESC";
